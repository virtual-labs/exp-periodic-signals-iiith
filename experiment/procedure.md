...
2. Click the "Generate" button to view the plot in the figure.
3. For ECG, guess the heart rate and click "Submit Guess".
4. For Double Pendulum, guess the time period and click "Submit Guess".
